export const itemsBoughtArr = [
    ...
    },
    {
        ...
        priceUSD: 15,
        desc: 'A can of soup that instantly chills itself when opened, so you can enjoy refreshing cold soup on a hot summer day.'
    },
    {
        name: 'Glow-in-the-Dark Eggs',
        priceUSD: 8,
        desc: 'A carton of eggs that glow in the dark, making breakfast preparation an excite illuminating experience.'
    }
];
